...
In this script, do this saving with with
...
To build this into a proper help file, you need to run
`devtools::document()`.  This will use roxygen2 to convert this to a *.Rd file in the `man` folder. This provides the "manual" for your data.
